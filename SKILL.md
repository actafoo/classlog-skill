---
name: classlog-app
description: ClassLog(교사용 형성평가 플랫폼)용 인터랙티브 HTML 학습앱을 만들거나, 기존 HTML 앱에 ClassLog 채점 연동을 반영하는 규격. 새로 만들 때는 교사에게 먼저 질문하고, 기존 앱은 분석 후 수술적으로 수정한다. 학생별 문항 정오답이 교사 대시보드에 자동 집계된다.
---
